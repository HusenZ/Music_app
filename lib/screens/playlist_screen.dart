...
import 'package:music_player/widgets/play_or_shuffle.dart';
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            Colors.amber.shade800.withOpacity(0.8),
    ...
    return Column(
      children: [
        ClipRRect(
          ...
          child: Image.network(
            'https://th.bing.com/th/id/OIP.gGOvdpfKu7xGCb_4L2tLbQHaEK?pid=ImgDet&rs=1',
